...
const controlRecipes = async function() {
    try {
        ...
        // 2. rendering recipe
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe); //this data is passed into the render method
    } catch (err) {
        console.error(err);
...
const loadSearchResults = async function(query) {
    try {
        ...
        state.search.page = 1; //page reset to 1 when load new page
    } catch  {
...
const getSearchResultsPage = function(page = state.search.page) {
    ...
    return state.search.results.slice(start, end); //slice doesnt include the last value, not 10 is not included
};
...
const KEY = "8540e079-0094-42e3-9bc3-b2dbdd16ef40";
...
},{"regenerator-runtime/runtime":"dXNgZ","regenerator-runtime":"dXNgZ","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l60JC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
// import icons from '../img/icons.svg'; //for parcel 1
var _iconsSvg = require("url:../../img/icons.svg"); //for parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _fracty = require("fracty"); // used destructuring, so Fraction becomes the actual function
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            // console.log(btn);
            const { updateTo  } = btn.dataset; //converted to camelCase
...
exports.default = new RecipeView(); //nothing outside of the object can have access to this
...
exports.default = new reviewView();
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    <div class='total-column'>total pages: ${numPages}</div>
